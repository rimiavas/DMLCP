...
function setup() {
  ...
  classifier.classify(img, gotResults);  // Call classify on the image
                                         // We do this in setup as we only want to do this once. We pass in a function
                                         // `gotResults` that will be called once the classifier has identified what our
                                         // image is. Note that we pass the name of the function, as an argument to
                                         // the function. In JavaScript functions can be treated as any other
